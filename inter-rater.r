...
yamashita<-weightedv6.dist(data,c(5:7,10:13,15:17,19,21:23,26:41),c(1:4,8:9,14,18,20,24:25))
...
data<-as.matrix(read.csv("savage.csv",header=TRUE,row.names=1))
data[,27:41]<-as.numeric(data[,27:41])
...
#create distance matrix
savage<-weightedv6.dist(data,c(5:7,10:13,15:17,19,21:23,26:41),c(1:4,8:9,14,18,20,24:25))

# ------------------------------------------------------

#import spreadsheet (multi-state):

data<-as.matrix(read.csv("sakai.csv",header=TRUE,row.names=1))
data[,27:41]<-as.numeric(data[,27:41])
...
#create distance matrix
sakai<-weightedv6.dist(data,c(5:7,10:13,15:17,19,21:23,26:41),c(1:4,8:9,14,18,20,24:25))

# -------------------------

#import spreadsheet (multi-state):

data<-as.matrix(read.csv("shimozaki.csv",header=TRUE,row.names=1))
data[,27:41]<-as.numeric(data[,27:41])
...
#create distance matrix
shimozaki<-weightedv6.dist(data,c(5:7,10:13,15:17,19,21:23,26:41),c(1:4,8:9,14,18,20,24:25))

# ---------------------------------------

#import spreadsheet (multi-state):

data<-as.matrix(read.csv("merritt.csv",header=TRUE,row.names=1))
data[,27:41]<-as.numeric(data[,27:41])
...
#create distance matrix
merritt<-weightedv6.dist(data,c(5:7,10:13,15:17,19,21:23,26:41),c(1:4,8:9,14,18,20,24:25))

library('vegan')

mantel(merritt,savage,permutations=10000,method="spearman")
# 0.3405
# 9.999e-05

mantel(merritt,sakai,permutations=10000,method="spearman")
# 0.3053
# 9.999e-05

mantel(merritt,yamashita,permutations=10000,method="spearman")
# 0.3327
# 9.999e-05

mantel(merritt,shimozaki,permutations=10000,method="spearman")
# 0.2922
# 9.999e-05

mantel(savage,shimozaki,permutations=10000,method="spearman")
# 0.3762
# 9.999e-05

mantel(savage, yamashita,permutations=10000,method="spearman")
# 0.3925
# 9.999e-05

mantel(savage,sakai,permutations=10000,method="spearman")
# 0.4854
# 9.999e-05

mantel(sakai,yamashita,permutations=10000,method="spearman")
# 0.4278
# 9.999e-05

mantel(sakai,shimozaki,permutations=10000,method="spearman")
# 0.3862
# 9.999e-05

mantel(yamashita,shimozaki,permutations=10000,method="spearman")
# 0.3518
# 9.999e-05